...
const results = {
    ...
    getWithHeaders: `curl "https://jsonplaceholder.typicode.com/todos/1" -X GET\n-H "Content-Type: application/json"`,
    getEscapeHeaders: `curl "https://jsonplaceholder.typicode.com/todos/1" -X GET\n-H "key: a \\\"strange\\\" value"`,
    post1: `curl "https://jsonplaceholder.typicode.com/posts" -X POST\n-H "Content-type: application/json; charset=UTF-8"\n-d "{\\\"id\\\":\\\"123-456-789\\\",\\\"key1\\\":\\\"value 1\\\",\\\"key2\\\":\\\"a \\\\\\"complex\\\\\\" value\\\"}"`,
    put1: `curl "https://jsonplaceholder.typicode.com/posts/1" -X PUT\n-H "Content-type: application/json; charset=UTF-8"\n-d "{\\\"id\\\":1,\\\"title\\\":\\\"foo\\\",\\\"body\\\":\\\"barzzz\\\",\\\"userId\\\":1}"`,
    patch1: `curl "https://jsonplaceholder.typicode.com/posts/1" -X PATCH\n-H "Content-type: application/json; charset=UTF-8"\n-d "{\\\"title\\\":\\\"foo patched\\\"}"`,
